  ...
  return (
      <div className="w-full">
        ...
        <div className="w-full bg-white px-10">
          ...
          {/* 파일 업로드 영역 */}
          <div
              className="w-full p-8 bg-white rounded-lg shadow-sm border border-gray-500/[0.11]-">  {/* 바깥 컨테이너 - 약간의 그림자 */}
            <div
                className={`
      w-full
    ...
    `}
            ...
            >
              {uploading ? (
                  <div className="flex flex-col items-center">
                    <div
                        className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-600 mb-4"></div>
                  ...
                  <>
                    ...
                    <p className="text-gray-500 text-lg font-semibold">동영상 파일을 드래그 앤 드롭하여
                            업로드</p>
          ...
          <div className="flex justify-end mt-6">
            <button
                className="px-4 py-2 bg-[#4285f4] text-white rounded-full font-semibold text-sm">
              다음
            </button>
          </div>
        </div>
